...
class DashboardLayout {
   ...
   *
   * This grid is not a real grid but a widget builder which enforce widget position.
   * Instead of using a grid, we expose a function to allow user to set the position of theirs widgets/components
   */
